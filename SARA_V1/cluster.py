...
class point:
    def __init__(self, ts = 0, gps_at_measurement = [], raw_measurement = [], abs_position = []):
    ...
    def calculateAbsPos(self, gps_origin, field_bearing, robot_bearing):
        dist_meters = self.raw[1] /1000.0
        abs_bearing = ((180 + field_bearing + robot_bearing + self.raw[0])%360)*deg_to_rad
