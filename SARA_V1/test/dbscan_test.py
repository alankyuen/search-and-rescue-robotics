...
class "DBSCAN"
    __init__
        variables: minPts, dist_e, time_e
        data struct: clusters, points, noise

    reset [_]
        -clears list of points and repopulates new ones
        -check time efficiency for the creation of points
